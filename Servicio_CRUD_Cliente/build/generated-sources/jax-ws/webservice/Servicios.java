...
public interface Servicios {
     ...
     * @param id
     * @return
     *     returns webservice.Movil
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "listarIDMarca", targetNamespace = "http://WebService/", className = "webservice.ListarIDMarca")
    @ResponseWrapper(localName = "listarIDMarcaResponse", targetNamespace = "http://WebService/", className = "webservice.ListarIDMarcaResponse")
    @Action(input = "http://WebService/Servicios/listarIDMarcaRequest", output = "http://WebService/Servicios/listarIDMarcaResponse")
    public Movil listarIDMarca(
     ...
     * 
     * @return
     *     returns java.util.List<webservice.Movil>
     */
    @WebMethod(operationName = "ListarM")
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "ListarM", targetNamespace = "http://WebService/", className = "webservice.ListarM")
    @ResponseWrapper(localName = "ListarMResponse", targetNamespace = "http://WebService/", className = "webservice.ListarMResponse")
    @Action(input = "http://WebService/Servicios/ListarMRequest", output = "http://WebService/Servicios/ListarMResponse")
